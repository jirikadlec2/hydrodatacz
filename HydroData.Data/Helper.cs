		...
		public static Dictionary<int, VariableInfo> Vars
		{
			get
			{
				return new Dictionary<int, VariableInfo>{
                        ...
                        ColumnName ="rain_mm_10",TableName="rain_hourly",ValueDescr="(mm)", MeasureUnit="(mm)"}},

						{2,new VariableInfo{Id=2, Name="precip_day", PageName ="DailyRainfall",
                        ColumnName ="rain_mm_10",TableName="rain_daily",ValueDescr="(mm)", MeasureUnit="(mm)"}},
                        ...
                        ColumnName ="snow_cm",TableName="snow",ValueDescr="(cm)", MeasureUnit="(cm)"}},
