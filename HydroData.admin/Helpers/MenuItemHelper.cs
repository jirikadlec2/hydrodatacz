...
namespace Helpers
{
	...
	{
		public static MvcHtmlString MenuItem(this HtmlHelper helper, string linkText, string actionName, string controllerName, object routeValues)
		{
			...
			sb.Append(helper.ActionLink(linkText, actionName, controllerName, routeValues, null));
